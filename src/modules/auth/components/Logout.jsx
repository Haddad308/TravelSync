...
export default function Logout() {
    ...
    return (
        <>
            <div onClick={onOpen} className={`flex items-center gap-2 p-2 mx-3 mb-2 text-white rounded-lg cursor-pointer transition-all duration-300 hover:bg-danger-500 `} >
