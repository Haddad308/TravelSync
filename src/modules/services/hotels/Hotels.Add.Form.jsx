    ...
    const formHandler = useFormik({
        ...
        validationSchema: () => {
            ...
            return Yup.object({
                ...
                phoneNumber: Yup.string().matches(phoneRegex, 'Invalid Egyptian phoneNumber number').required('Required'),
                    ...
                    {(onClose) => (
                        <form onSubmit={formHandler.handleSubmit} >
                            ...
                            <ModalBody className="flex flex-row items-center">
                                ...
                                <div className="w-1/2">
                                    <ImagesUploader files={agencyImage} setFiles={setAgencyImage} isMultiple={true} isOnly={false} />
                                </div>
                            </ModalBody>
                            <ModalFooter>
