...
const ReservationPage = () => {
    ...
    const handleUpdate = () => getReservation(setReservation, setIsLoading, "", id);
            ...
            {isLoading ?
                ...
                <>
                        ...
                        <div className="text-black flex justify-evenly items-center mb-5">
                            <div className="flex items-center justify-center ">
                                ...
                                <div className="flex flex-col ml-5">
                                    <h4 className="text-md font-semibold">{name?.slice(0, 20)}{name?.length > 20 ? "...." : ""}</h4>
                                    <h5 className="text-md text-gray-600"> {email?.slice(0, 20)}{email?.length > 20 ? "...." : ""}</h5>
                    ...
                    <div className="flex flex-col   " >
                        {CancelReason ? <div className="bg-gray-200 p-6 rounded-3xl mb-5" >
                            <p>{CancelReason}</p>
                        </div> : ""}
                        <div className="flex gap-4 justify-center  mb-5" >
                            {status == "pending" ? <CancelReservation id={id} handleUpdate={handleUpdate} /> : ""}
