...
const UserAccount = () => {
    ...
    const [transition, setTransition] = useState([]); const { pathname } = location;
                        ...
                        <div className="text-black flex justify-evenly items-center p-4">
                            <div className="flex items-center justify-center ">
                                ...
                                <div className="flex flex-col ml-5">
                                    <h4 className="text-md font-semibold">{account?.travelOffice?.name}</h4>
                                    <h5 className="text-md text-gray-600">{account?.travelOffice?.email}</h5>
                            ...
                            <div>
                                <h1 className="text-lg font-bold mb-2">{account?.travelOffice?.name}</h1>
                            ...
                            <div >
                                ...
                                <p className="text-sm text-center">{account?.currentBalance}$</p>
                            </div>
                        </div>
                    </div>
