            ...
            <div className="m-6 bg-white rounded-3xl" >
                <div className="p-4" >
                    ...
                    <div className="grid grid-cols-3 mt-5 gap-5" >
                        {accounts.slice(0, 3).map(({ id, travelOffice, currentBalance }) => {
                            return <UserBalance key={id} id={id} AgnecyName={travelOffice?.name} AgnecyEmail={travelOffice?.email} AgencyBalance={currentBalance} />
                        })}
                    </div>
                </div>
            </div>
